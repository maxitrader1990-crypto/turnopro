    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-[#111] p-12 rounded-2xl border border-white/10 flex flex-col items-center justify-center text-center">
                ...
                <h3 className="text-2xl font-bold text-white mb-2">En Construcción</h3>
                <p className="text-gray-400 max-w-md">
                    El módulo de gestión financiera global está siendo desarrollado.
                    Pronto podrás ver métricas de ingresos, suscripciones y payouts aquí.
                </p>
            </div>
        </div>
    );
