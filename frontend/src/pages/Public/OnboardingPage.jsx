                ...
                {!user && (
                    <div className="mt-4">
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-3 py-3 px-4 border border-gray-300 rounded-xl shadow-sm bg-white text-gray-900 font-bold hover:bg-gray-50 transition-all hover:scale-[1.02]"
                        >
